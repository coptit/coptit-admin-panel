  ...
  return (
    <div className="">
      <div className="flex justify-center h-[80%]">
        <div className="p-4 m-8 grow rounded border-solid border-2 flex flex-col ">
        ...
        <div className="p-4 m-8 grow rounded border-solid border-2">
      ...
      <button
        className="w-24 font-bold text-black px-8 py-2 m-8 bg-[#F4C868] hover:bg-[#eda812] rounded hover:scale-110 duration-300 active:bg-black active:text-white "
        onClick={async (e) => {
          e.preventDefault;
